...
import api.classRecord.ApuestaRecord;
...
import api.jpacasino.ApuestaJpaController;
    ...
    public Response finalizarJuego(ApuestaRecord apuesta, @Context ContainerRequestContext requestContext) {
        ...
        collection.find(
                ...
                doc -> {
                    ...
                    apuestaBD.setMontoApostado(doc.get("monto_apostado", Decimal128.class).bigDecimalValue());
