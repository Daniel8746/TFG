...
import api.classRecord.UsuarioRecord;
...
import api.jpacasino.UsuarioJpaController;
...
public class ServiceRestUsuario {
    ...
    public Response getUsuario(UsuarioRecord usuario, @Context ContainerRequestContext requestContext) {
        ...
        if ("sin-token".equals(correo)) {
            ...
            UsuarioRecord usuarioEncontrado = dao.findUsuarioRecord(usuario);
        ...
        UsuarioRecord usuarioEncontrado = dao.findUsuarioRecord(correo);
    ...
    public Response crearUsuario(Usuario usuario) {
        ...
        UsuarioRecord usuarioEncontrado = dao.findUsuarioRecord(
                new UsuarioRecord(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(
            summary = "Actualizar saldo del usuario",
            description = "Actualiza el saldo del usuario en la base de datos.",
            requestBody = @RequestBody(
                    required = true,
                    content = @Content(
                            mediaType = "application/json",
