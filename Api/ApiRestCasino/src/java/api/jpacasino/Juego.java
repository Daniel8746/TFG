...
@NamedQueries({
    ...
    @NamedQuery(name = "Juego.findByTipo", query = "SELECT j FROM Juego j WHERE j.tipo = :tipo")})
public class Juego implements Serializable {
    ...
    public Juego(Integer id, String nombre, String tipo) {
        this.id = id;
        this.nombre = nombre;
        this.tipo = tipo;
    }
